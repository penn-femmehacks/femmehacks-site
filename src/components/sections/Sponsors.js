      ...
      <Section id="sponsors" accent>
        <StyledContainer>
          <div>
            ...
            <p> Interested in sponsoring FemmeHacks 2023? Feel free to reach out to <a href="mailto:sponsor@femmehacks.io">sponsor@femmehacks.io</a>, we'd love to hear from you!</p>
          </div>
          {/* <Art>
